...
## ENV HELPERS TESTS
## ============================================================
def test_get_env_str_returns_default_when_missing(
...
def test_get_env_str_returns_value(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    """
        Validate get_env_str returns actual value when env variable exists
    ...
    assert get_env_str("TEST_ENV_STR", "default") == "hello"

def test_get_env_int_returns_default_on_invalid(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    """
...
def test_get_env_int_valid(
    ...
    """
        Validate get_env_int parses valid integer values
    ...
    assert get_env_int("TEST_ENV_INT", 0) == 42

def test_get_env_bool_parses_true_false(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    """
...
def test_get_env_bool_default(
    ...
    """
        Validate get_env_bool returns default when env variable is missing
    ...
    assert get_env_bool("TEST_ENV_BOOL", True) is True
...
def test_log_and_raise_missing_path_raises_data_error(
    tmp_path: Path,
) -> None:
    """
...
def test_log_and_raise_missing_path_valid(
    tmp_path: Path,
) -> None:
    """
        Validate existing path does not require missing-path helper behavior
...
## ============================================================
def test_build_pipeline_config_success(
    monkeypatch: pytest.MonkeyPatch,
    tmp_path: Path,
) -> None:
    """
...
def test_build_pipeline_config_missing_required_env(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    """
...
def test_build_pipeline_config_invalid_mode(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    """
        Validate build_pipeline_config fails on invalid mode
